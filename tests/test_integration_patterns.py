"""Integration-pattern tests — mirror how downstream application consumes pyfreepbx.

pyfreepbx is the most-used vendor SDK in downstream application (16 call-site files across
...
# ---------------------------------------------------------------------------
# Public exports — the names downstream application imports
# ---------------------------------------------------------------------------
...
class TestPublicExports:
    ...
    def test_consumer_critical_names_exported(self) -> None:
        # The exact symbols downstream application call sites import (audit doc).
        required = {
            "FreePBX",
            "AMIEvent",
            "AMIEventListener",
...
# ---------------------------------------------------------------------------
# Facade construction & URL parsing — exactly how downstream application builds the client
# ---------------------------------------------------------------------------
...
class TestConfigContract:
    def test_oauth2_detection(self) -> None:
        # has_oauth2 drives the facade's token-provider wiring + downstream application auth-mode precedence.
