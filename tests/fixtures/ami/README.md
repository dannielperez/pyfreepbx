...
the UniqueOS `CallSession` ingestion layer (OPS-SNAP-4/5). Each file is a verbatim
...
- **Source:** live production PBX `pbx.uniquesecpr.com` (read-only AMI, `admin` account).
