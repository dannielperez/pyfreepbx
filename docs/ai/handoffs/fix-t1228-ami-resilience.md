...
- state: done · PR: #15 draft CI:pending (docs-only handoff rerun; implementation SHA was green) · changed: AMI client/config and focused tests
...
- next: owner review/merge only · knowledge: n/a
